---
title: "dplyr Superhero - Homework 5"
...
## #   ³​publisher, ⁴​skin_color, ⁵​alignment
```
Since 37 of the goodies and 35 of the baddies have No Hair, more good guys are bald. 
...
11. Just to be clear on the `|` operator,  have a look at the superheros over 200 in height...
...
##  9 Beta Ray … Male   <NA>    <NA>  No Hair    201 Marvel… <NA>    good       216
## 10 Bloodaxe   Female blue    Human Brown      218 Marvel… <NA>    bad        495
## # … with 49 more rows, and abbreviated variable names ¹​eye_color, ²​hair_color,
## #   ³​publisher, ⁴​skin_color, ⁵​alignment
```
...
## # … with 724 more rows
```
Groot, Galactus, and Fing Fang Foom have the highest height-to-weight ratios.
...
```
97 have accelerated_healing, durability, and super strength.
...
##   <chr>   <lgl>   <lgl>   <lgl>   <lgl>   <lgl>   <lgl>   <lgl>   <lgl>   <lgl> 
## 1 Wonder… TRUE    FALSE   FALSE   FALSE   FALSE   TRUE    FALSE   FALSE   TRUE  
