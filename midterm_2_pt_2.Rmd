...
surgery%>% 
  ...
  labs(title = "Surgery Study Participants by Race ",
       x = "Race",
       fill = "n")
```
...
surgery %>% 
  ...
  geom_bar()+ 
  theme(axis.text.x = element_text(angle = 60, hjust = 1))+
  labs(title = "ASA of Study Participants",
       x = "ASA Status",
       fill = "n")
```
...
surgery %>% 
  ...
  coord_flip()+
  theme(axis.text.x = element_text(angle = 60, hjust = 1))+
  labs(title = "30-Day Mortality Rate for Surgical Procedures",
       x = "Procedure",
...
#surgery %>% 
 ...
 # geom_col(position ="dodge")+
  #ggtitle("Month and Mortality Count")
```
